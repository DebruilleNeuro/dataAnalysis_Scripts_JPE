...
name='ICs_ICA_0.1HZ_C6J1H1.set';%load manually if does not work and run from line 19 redraw
currentPath = pwd;
...
addpath (genpath('C:\Users\jeula\Documents\current subjects\fieldtrip\fieldtrip-20190410'))
% ft_defaults
% addpath 'C:\Users\jeula\Documents\current subjects\fieldtrip\fieldtrip-20190410\external\eeglab'
...
filenameshort = filename(end-5:end)
        ...
        name1=[filenameshort, '_SBD_AVG'];
        name2=[filenameshort, '_DBD_AVG'];
